...
const PortfilioCard = ({img,title,tech1,tech2,tech3,tech4, tech5,tech6}) => {
  return (
      <div  className=" cursor-pointer card relative shadow-md shadow-blue-600 w-[90%] h-80 md:h-[90%] flex flex-col justify-center items-center bg-zinc-900 mb-10 rounded-lg">
    <img
    ...
    <div className="absolute h-[18%] md:h-[15%] lg:h-[12%] xl:h-[10%]  bottom-3  w-[90%] rounded-lg bg-zinc-900 overflow-hidden">
